...
function Table({ data }) {
  ...
  return (
    <div className="">
      <div className="w-full text-center rounded-tr-lg rounded-lg bg-[#40CF8F] border-b-transparent px-1 pb-2">
        ...
        <div
          className="py-2 bg-white flex items-center justify-center gap-2"
